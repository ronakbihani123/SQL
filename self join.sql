...
-- self join is a kind of join where table join by itself
...
select emp.emp_id , emp.emp_name ,emp.manager_id,manager.emp_id , 
manager.emp_name , emp.salary , manager.salary from employee as emp
